...
public class LoginSteps extends PomClass{
	...
	public void user_should_be_login_and_navigated_to_dashboard_page() {
	    ...
	    if(homePage.contains("dashboard")) {
	    	System.out.println("User have Valid Credentials and Login Successfully");
	    }
	    else {
	    	System.out.println("User have InValid Credentials and Login Failed ");
	    }
